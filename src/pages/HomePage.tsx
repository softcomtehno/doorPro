    ...
    <div>
      ...
      <section className="relative h-[500px] md:h-[600px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.pexels.com/photos/276528/pexels-photo-276528.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)",
          }}
        >
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="max-w-xl">
            ...
            <p className="text-xl text-white mb-8 animate-fadeIn animation-delay-200">
              Широкий выбор межкомнатных и входных дверей от лучших
              производителей
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#3A2618] mb-8">
            Категории дверей
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <CategoryCard
              ...
              image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS28IoPYrNjrIoh-FnqVhyNO8fO9xfpnYTmRQ&s"
            ...
            <CategoryCard
              ...
              image="https://dvery-pro.ru/images/razdvig/stati/6167affea2e96cb4430a1b90fa57b34e0e1dbf00_900.jpg"
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#3A2618] mb-12">
            Почему выбирают нас
          </h2>
      ...
      <section className="py-16 bg-[#3A2618] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Наши специалисты помогут подобрать двери, которые идеально подойдут
...
const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <Link
      to={link}
      className="group block relative rounded-lg overflow-hidden h-64 shadow-md"
    >
      <img
        src={image}
        alt={title}
