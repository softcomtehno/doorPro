    ...
    <footer className="bg-[#3A2618] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Мы предлагаем широкий ассортимент качественных межкомнатных и
              входных дверей от лучших производителей.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p>г. Бишкек, Улица Исакеева, 34/1</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300 text-sm">
          <p>
            © 2025 ДвериПро — Интернет-магазин межкомнатных и входных дверей.
            Все права защищены.
          </p>
        </div>
      </div>
